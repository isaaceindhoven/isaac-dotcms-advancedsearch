...
//	}
	...
	protected void addSpringController(BundleContext context, String path, String contextConfigLocation) {
		Logger.info(this.getClass().getName(), "Registering spring controller " + contextConfigLocation);

		try {
			publishBundleServices(context);
		} catch (Exception e) {
			Logger.warn(this.getClass().getName(), "Unable to publish bundle services", e);
		}
